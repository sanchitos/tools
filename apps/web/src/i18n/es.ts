...
export const es: Dictionary = {
  ...
  // --- Auth (registro / inicio de sesión / confirmación) --------------------
  'auth.signupTitle': 'Crea tu cuenta',
  'auth.signupSubtitle': 'Da seguimiento a tus pedidos y compra más rápido.',
  'auth.loginTitle': 'Iniciar sesión',
  'auth.loginSubtitle': 'Bienvenido de nuevo.',
  'auth.fullName': 'Nombre completo',
  'auth.fullNamePlaceholder': 'Juana Pérez',
  ...
  'auth.checkInboxTitle': 'Revisa tu correo',
  'auth.checkInboxBody':
    'Enviamos un enlace de confirmación a {email}. Ábrelo para terminar de configurar tu cuenta.',
  'auth.resend': 'Reenviar el correo',
  'auth.resending': 'Enviando…',
  'auth.resent': 'Enviado. Revisa tu correo en un momento.',
  'auth.confirming': 'Confirmando tu correo…',
  'auth.confirmFailedTitle': 'Ese enlace no funcionó',
  'auth.confirmMissingToken': 'Este enlace de confirmación está incompleto. Solicita uno nuevo abajo.',
  'auth.resendPrompt': 'Ingresa tu correo y te enviaremos un enlace nuevo.',
  'auth.notConfirmed': 'Primero confirma tu dirección de correo.',
  'auth.error.emailRequired': 'Ingresa un correo electrónico válido',
  'auth.error.passwordLength': 'Usa al menos 8 caracteres',
  ...
  'account.orderItems': 'Artículos',
  'account.orderTotal': 'Subtotal',
  'account.orderStatus': 'Estado',
  'account.itemCount_one': '{count} artículo',
  'account.itemCount_other': '{count} artículos',
  'account.status.new': 'Nuevo',
  'account.status.confirmed': 'Confirmado',
  'account.status.fulfilled': 'Entregado',
