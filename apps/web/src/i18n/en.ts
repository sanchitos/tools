...
export const en = {
  ...
  'auth.signupSubtitle': 'Track your orders and check out faster.',
  'auth.loginTitle': 'Sign in',
  'auth.loginSubtitle': 'Welcome back.',
  'auth.fullName': 'Full name',
  'auth.fullNamePlaceholder': 'Jane Shopper',
  'auth.email': 'Email',
  ...
  'auth.checkInboxBody': 'We sent a confirmation link to {email}. Open it to finish setting up your account.',
  'auth.resend': 'Resend the email',
  'auth.resending': 'Sending…',
  'auth.resent': 'Sent. Check your inbox again in a moment.',
  'auth.confirming': 'Confirming your email…',
  'auth.confirmFailedTitle': "That link didn't work",
  'auth.confirmMissingToken': 'This confirmation link is incomplete. Request a new one below.',
  'auth.resendPrompt': 'Enter your email and we will send a fresh link.',
  'auth.notConfirmed': 'Please confirm your email address first.',
  'auth.error.emailRequired': 'Enter a valid email address',
  'auth.error.passwordLength': 'Use at least 8 characters',
  ...
  'account.orderTotal': 'Subtotal',
  'account.orderStatus': 'Status',
  'account.itemCount_one': '{count} item',
  'account.itemCount_other': '{count} items',
  'account.status.new': 'New',
